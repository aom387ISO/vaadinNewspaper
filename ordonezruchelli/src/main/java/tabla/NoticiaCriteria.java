...
public class NoticiaCriteria extends AbstractORMCriteria {
	...
	public NoticiaCriteria(Criteria criteria) {
		...
		está_contenida = new CollectionExpression("ORM_está_contenida", this);
	...
	public SeccionCriteria createEstá_contenidaCriteria() {
		return new SeccionCriteria(createCriteria("ORM_está_contenida"));
	}
