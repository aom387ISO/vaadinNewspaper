...
public class FotoDAO {
	...
	public static Foto loadFotoByORMID(PersistentSession session, int idFoto) throws PersistentException {
		try {
			return (Foto) session.load(tabla.Foto.class, Integer.valueOf(idFoto));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Foto getFotoByORMID(PersistentSession session, int idFoto) throws PersistentException {
		try {
			return (Foto) session.get(tabla.Foto.class, Integer.valueOf(idFoto));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Foto loadFotoByORMID(PersistentSession session, int idFoto, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Foto) session.load(tabla.Foto.class, Integer.valueOf(idFoto), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Foto getFotoByORMID(PersistentSession session, int idFoto, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Foto) session.get(tabla.Foto.class, Integer.valueOf(idFoto), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryFoto(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From tabla.Foto as Foto");
		if (condition != null)
	...
	public static Foto createFoto() {
		return new tabla.Foto();
	}
	
	public static boolean save(tabla.Foto foto) throws PersistentException {
		try {
	...
	public static boolean delete(tabla.Foto foto) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(tabla.Foto foto)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(tabla.Foto foto, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (foto.getPertenece() != null) {
				foto.getPertenece().contiene.remove(foto);
			}
	...
	public static boolean refresh(tabla.Foto foto) throws PersistentException {
		try {
	...
	public static boolean evict(tabla.Foto foto) throws PersistentException {
		try {
