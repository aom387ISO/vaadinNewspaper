...
public class ComentarioDAO {
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int idComentario) throws PersistentException {
		try {
			return (Comentario) session.load(tabla.Comentario.class, Integer.valueOf(idComentario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int idComentario) throws PersistentException {
		try {
			return (Comentario) session.get(tabla.Comentario.class, Integer.valueOf(idComentario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int idComentario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.load(tabla.Comentario.class, Integer.valueOf(idComentario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int idComentario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.get(tabla.Comentario.class, Integer.valueOf(idComentario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryComentario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From tabla.Comentario as Comentario");
		if (condition != null)
	...
	public static Comentario createComentario() {
		return new tabla.Comentario();
	}
	
	public static boolean save(tabla.Comentario comentario) throws PersistentException {
		try {
			ProyectofinalPersistentManager.instance().saveObject(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(tabla.Comentario comentario) throws PersistentException {
		try {
			ProyectofinalPersistentManager.instance().deleteObject(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(tabla.Comentario comentario)throws PersistentException {
		try {
			if (comentario.getComenta() != null) {
				comentario.getComenta().comentada_por.remove(comentario);
			}
			
			if (comentario.getAutor() != null) {
				comentario.getAutor().escribir.remove(comentario);
			}
			
			tabla.ValoracionComentario[] lValoracionComentarios = comentario.valoracionComentario.toArray();
			for(int i = 0; i < lValoracionComentarios.length; i++) {
				lValoracionComentarios[i].setLe_da_valoracion(null);
			}
	...
	public static boolean deleteAndDissociate(tabla.Comentario comentario, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (comentario.getComenta() != null) {
				comentario.getComenta().comentada_por.remove(comentario);
			}
	...
	public static boolean refresh(tabla.Comentario comentario) throws PersistentException {
		try {
			ProyectofinalPersistentManager.instance().getSession().refresh(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(tabla.Comentario comentario) throws PersistentException {
		try {
			ProyectofinalPersistentManager.instance().getSession().evict(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
