...
public class Periodista extends tabla.Usuario implements Serializable {
	public Periodista() {
	}
	...
	@OneToMany(mappedBy="autor", targetEntity=tabla.Noticia.class)	
	...
	@Transient	
	public final tabla.NoticiaSetCollection publica = new tabla.NoticiaSetCollection(this, _ormAdapter, ORMConstants.KEY_PERIODISTA_PUBLICA, ORMConstants.KEY_NOTICIA_AUTOR, ORMConstants.KEY_MUL_ONE_TO_MANY);
