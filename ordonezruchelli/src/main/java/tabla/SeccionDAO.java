...
public class SeccionDAO {
	...
	public static Seccion loadSeccionByORMID(PersistentSession session, String idSeccion) throws PersistentException {
		try {
			return (Seccion) session.load(tabla.Seccion.class, idSeccion);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Seccion getSeccionByORMID(PersistentSession session, String idSeccion) throws PersistentException {
		try {
			return (Seccion) session.get(tabla.Seccion.class, idSeccion);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Seccion loadSeccionByORMID(PersistentSession session, String idSeccion, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Seccion) session.load(tabla.Seccion.class, idSeccion, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Seccion getSeccionByORMID(PersistentSession session, String idSeccion, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Seccion) session.get(tabla.Seccion.class, idSeccion, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List querySeccion(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From tabla.Seccion as Seccion");
		if (condition != null)
	...
	public static Seccion createSeccion() {
		return new tabla.Seccion();
	}
	
	public static boolean save(tabla.Seccion seccion) throws PersistentException {
		try {
	...
	public static boolean delete(tabla.Seccion seccion) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(tabla.Seccion seccion)throws PersistentException {
		try {
			tabla.Noticia[] lSe_encuentras = seccion.se_encuentra.toArray();
			for(int i = 0; i < lSe_encuentras.length; i++) {
				lSe_encuentras[i].está_contenida.remove(seccion);
			}
	...
	public static boolean deleteAndDissociate(tabla.Seccion seccion, org.orm.PersistentSession session)throws PersistentException {
		try {
			tabla.Noticia[] lSe_encuentras = seccion.se_encuentra.toArray();
			for(int i = 0; i < lSe_encuentras.length; i++) {
				lSe_encuentras[i].está_contenida.remove(seccion);
	...
	public static boolean refresh(tabla.Seccion seccion) throws PersistentException {
		try {
	...
	public static boolean evict(tabla.Seccion seccion) throws PersistentException {
		try {
