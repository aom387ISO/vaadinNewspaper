...
public class Usuario_suscritoDAO {
	...
	public static Usuario_suscrito loadUsuario_suscritoByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Usuario_suscrito) session.load(tabla.Usuario_suscrito.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario_suscrito getUsuario_suscritoByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Usuario_suscrito) session.get(tabla.Usuario_suscrito.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario_suscrito loadUsuario_suscritoByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario_suscrito) session.load(tabla.Usuario_suscrito.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario_suscrito getUsuario_suscritoByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario_suscrito) session.get(tabla.Usuario_suscrito.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUsuario_suscrito(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From tabla.Usuario_suscrito as Usuario_suscrito");
		if (condition != null)
	...
	public static Usuario_suscrito createUsuario_suscrito() {
		return new tabla.Usuario_suscrito();
	}
	
	public static boolean save(tabla.Usuario_suscrito usuario_suscrito) throws PersistentException {
		try {
	...
	public static boolean delete(tabla.Usuario_suscrito usuario_suscrito) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(tabla.Usuario_suscrito usuario_suscrito)throws PersistentException {
		try {
			tabla.Foto[] lTiene_imagens = usuario_suscrito.tiene_imagen.toArray();
			for(int i = 0; i < lTiene_imagens.length; i++) {
				lTiene_imagens[i].setLe_da_imagen_a(null);
			}
			tabla.Comentario[] lEscribirs = usuario_suscrito.escribir.toArray();
			for(int i = 0; i < lEscribirs.length; i++) {
				lEscribirs[i].setAutor(null);
			}
			tabla.ValoracionNoticia[] lValora_as = usuario_suscrito.valora_a.toArray();
			for(int i = 0; i < lValora_as.length; i++) {
				lValora_as[i].setValorada_por(null);
			}
			tabla.ValoracionComentario[] lVa_a_valorars = usuario_suscrito.va_a_valorar.toArray();
	...
	public static boolean deleteAndDissociate(tabla.Usuario_suscrito usuario_suscrito, org.orm.PersistentSession session)throws PersistentException {
		try {
			tabla.Foto[] lTiene_imagens = usuario_suscrito.tiene_imagen.toArray();
			for(int i = 0; i < lTiene_imagens.length; i++) {
				lTiene_imagens[i].setLe_da_imagen_a(null);
	...
	public static boolean refresh(tabla.Usuario_suscrito usuario_suscrito) throws PersistentException {
		try {
	...
	public static boolean evict(tabla.Usuario_suscrito usuario_suscrito) throws PersistentException {
		try {
