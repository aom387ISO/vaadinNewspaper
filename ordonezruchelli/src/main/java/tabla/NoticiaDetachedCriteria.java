...
public class NoticiaDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public final CollectionExpression está_contenida;
	...
	public NoticiaDetachedCriteria() {
		super(tabla.Noticia.class, tabla.NoticiaCriteria.class);
		...
		está_contenida = new CollectionExpression("ORM_está_contenida", this.getDetachedCriteria());
	...
	public NoticiaDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, tabla.NoticiaCriteria.class);
		idNoticia = new IntegerExpression("idNoticia", this.getDetachedCriteria());
		autorId = new IntegerExpression("autor.", this.getDetachedCriteria());
		autor = new AssociationExpression("autor", this.getDetachedCriteria());
		titulo = new StringExpression("titulo", this.getDetachedCriteria());
	...
	public SeccionDetachedCriteria createEstá_contenidaCriteria() {
		return new SeccionDetachedCriteria(createCriteria("ORM_está_contenida"));
	}
