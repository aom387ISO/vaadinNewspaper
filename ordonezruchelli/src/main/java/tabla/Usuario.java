...
public class Usuario implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="TABLA_USUARIO_IDUSUARIO_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="TABLA_USUARIO_IDUSUARIO_GENERATOR", strategy="native")	
	...
	@OneToMany(mappedBy="le_da_imagen_a", targetEntity=tabla.Foto.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	private java.util.Set ORM_tiene_imagen = new java.util.HashSet();
	
	@OneToMany(mappedBy="autor", targetEntity=tabla.Comentario.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	private java.util.Set ORM_escribir = new java.util.HashSet();
	
	@OneToMany(mappedBy="valorada_por", targetEntity=tabla.ValoracionNoticia.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	private java.util.Set ORM_valora_a = new java.util.HashSet();
	
	@OneToMany(mappedBy="valorado_por", targetEntity=tabla.ValoracionComentario.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	...
	@Transient	
	public final tabla.FotoSetCollection tiene_imagen = new tabla.FotoSetCollection(this, _ormAdapter, ORMConstants.KEY_USUARIO_TIENE_IMAGEN, ORMConstants.KEY_FOTO_LE_DA_IMAGEN_A, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	@Transient	
	public final tabla.ComentarioSetCollection escribir = new tabla.ComentarioSetCollection(this, _ormAdapter, ORMConstants.KEY_USUARIO_ESCRIBIR, ORMConstants.KEY_COMENTARIO_AUTOR, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	@Transient	
	public final tabla.ValoracionNoticiaSetCollection valora_a = new tabla.ValoracionNoticiaSetCollection(this, _ormAdapter, ORMConstants.KEY_USUARIO_VALORA_A, ORMConstants.KEY_VALORACIONNOTICIA_VALORADA_POR, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	@Transient	
	public final tabla.ValoracionComentarioSetCollection va_a_valorar = new tabla.ValoracionComentarioSetCollection(this, _ormAdapter, ORMConstants.KEY_USUARIO_VA_A_VALORAR, ORMConstants.KEY_VALORACIONCOMENTARIO_VALORADO_POR, ORMConstants.KEY_MUL_ONE_TO_MANY);
