...
public class Tematica implements Serializable {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_TEMATICA_DA_TEMATICA) {
			this.da_tematica = (tabla.Seccion) owner;
		}
	}
	...
	@OneToOne(targetEntity=tabla.Seccion.class, fetch=FetchType.LAZY)	
	...
	private tabla.Seccion da_tematica;
	
	@ManyToMany(targetEntity=tabla.Noticia.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})	
	...
	@Transient	
	public final tabla.NoticiaSetCollection da_tematica_a = new tabla.NoticiaSetCollection(this, _ormAdapter, ORMConstants.KEY_TEMATICA_DA_TEMATICA_A, ORMConstants.KEY_NOTICIA_INCLUYE, ORMConstants.KEY_MUL_MANY_TO_MANY);
	
	public void setDa_tematica(tabla.Seccion value) {
		if (this.da_tematica != value) {
			tabla.Seccion lda_tematica = this.da_tematica;
	...
	public tabla.Seccion getDa_tematica() {
		return da_tematica;
	}
