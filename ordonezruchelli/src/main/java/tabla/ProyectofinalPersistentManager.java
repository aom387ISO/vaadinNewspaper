...
public class ProyectofinalPersistentManager extends PersistentManager {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(tabla.Noticia.class);
		aMetadataSources.addAnnotatedClass(tabla.Usuario.class);
		aMetadataSources.addAnnotatedClass(tabla.Periodista.class);
		aMetadataSources.addAnnotatedClass(tabla.Usuario_suscrito.class);
		aMetadataSources.addAnnotatedClass(tabla.Editor.class);
		aMetadataSources.addAnnotatedClass(tabla.Comentario.class);
		aMetadataSources.addAnnotatedClass(tabla.Seccion.class);
		aMetadataSources.addAnnotatedClass(tabla.Tematica.class);
		aMetadataSources.addAnnotatedClass(tabla.Foto.class);
		aMetadataSources.addAnnotatedClass(tabla.ValoracionNoticia.class);
		aMetadataSources.addAnnotatedClass(tabla.ValoracionComentario.class);
	}
