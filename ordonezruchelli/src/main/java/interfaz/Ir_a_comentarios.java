...
public class Ir_a_comentarios extends VistaIracomentarios{
	...
	public Ir_a_comentarios (Ver_noticia_cortada verNoticiaCortada, Usuario_no_suscrito usuarioNoSuscrito) {
		super();
	    this._ver_noticia_cortada = verNoticiaCortada;
	    this._lista_de_comentarios = new Lista_de_comentarios(usuarioNoSuscrito);
