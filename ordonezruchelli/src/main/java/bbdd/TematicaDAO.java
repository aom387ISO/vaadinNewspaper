...
public class TematicaDAO {
	...
	public static Tematica loadTematicaByORMID(PersistentSession session, String idTematica) throws PersistentException {
		try {
			return (Tematica) session.load(bbdd.Tematica.class, idTematica);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tematica getTematicaByORMID(PersistentSession session, String idTematica) throws PersistentException {
		try {
			return (Tematica) session.get(bbdd.Tematica.class, idTematica);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tematica loadTematicaByORMID(PersistentSession session, String idTematica, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tematica) session.load(bbdd.Tematica.class, idTematica, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tematica getTematicaByORMID(PersistentSession session, String idTematica, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tematica) session.get(bbdd.Tematica.class, idTematica, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryTematica(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd.Tematica as Tematica");
		if (condition != null)
	...
	public static Tematica createTematica() {
		return new bbdd.Tematica();
	}
	
	public static boolean save(bbdd.Tematica tematica) throws PersistentException {
		try {
	...
	public static boolean delete(bbdd.Tematica tematica) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.Tematica tematica)throws PersistentException {
		try {
			if (tematica.getDa_tematica() != null) {
				tematica.getDa_tematica().setIncluye(null);
			}
			
			bbdd.Noticia[] lDa_tematica_as = tematica.da_tematica_a.toArray();
	...
	public static boolean deleteAndDissociate(bbdd.Tematica tematica, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (tematica.getDa_tematica() != null) {
				tematica.getDa_tematica().setIncluye(null);
			}
	...
	public static boolean refresh(bbdd.Tematica tematica) throws PersistentException {
		try {
	...
	public static boolean evict(bbdd.Tematica tematica) throws PersistentException {
		try {
