...
public class NoticiaDAO {
	...
	public static Noticia loadNoticiaByORMID(PersistentSession session, int idNoticia) throws PersistentException {
		try {
			return (Noticia) session.load(bbdd.Noticia.class, Integer.valueOf(idNoticia));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Noticia getNoticiaByORMID(PersistentSession session, int idNoticia) throws PersistentException {
		try {
			return (Noticia) session.get(bbdd.Noticia.class, Integer.valueOf(idNoticia));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Noticia loadNoticiaByORMID(PersistentSession session, int idNoticia, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Noticia) session.load(bbdd.Noticia.class, Integer.valueOf(idNoticia), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Noticia getNoticiaByORMID(PersistentSession session, int idNoticia, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Noticia) session.get(bbdd.Noticia.class, Integer.valueOf(idNoticia), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryNoticia(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd.Noticia as Noticia");
		if (condition != null)
	...
	public static Noticia createNoticia() {
		return new bbdd.Noticia();
	}
	
	public static boolean save(bbdd.Noticia noticia) throws PersistentException {
		try {
	...
	public static boolean delete(bbdd.Noticia noticia) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.Noticia noticia)throws PersistentException {
		try {
			if (noticia.getAutor() != null) {
				noticia.getAutor().publica.remove(noticia);
			}
			
			bbdd.Seccion[] lEsta_contenidas = noticia.esta_contenida.toArray();
			for(int i = 0; i < lEsta_contenidas.length; i++) {
				lEsta_contenidas[i].se_encuentra.remove(noticia);
			}
			bbdd.Comentario[] lComentada_pors = noticia.comentada_por.toArray();
			for(int i = 0; i < lComentada_pors.length; i++) {
				lComentada_pors[i].setComenta(null);
			}
			bbdd.Tematica[] lIncluyes = noticia.incluye.toArray();
			for(int i = 0; i < lIncluyes.length; i++) {
				lIncluyes[i].da_tematica_a.remove(noticia);
			}
			bbdd.Foto[] lContienes = noticia.contiene.toArray();
			for(int i = 0; i < lContienes.length; i++) {
				lContienes[i].setPertenece(null);
			}
			bbdd.ValoracionNoticia[] lValoracionNoticiass = noticia.valoracionNoticias.toArray();
	...
	public static boolean deleteAndDissociate(bbdd.Noticia noticia, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (noticia.getAutor() != null) {
				noticia.getAutor().publica.remove(noticia);
			}
	...
	public static boolean refresh(bbdd.Noticia noticia) throws PersistentException {
		try {
	...
	public static boolean evict(bbdd.Noticia noticia) throws PersistentException {
		try {
