...
public class ValoracionNoticiaDAO {
	...
	public static ValoracionNoticia loadValoracionNoticiaByORMID(PersistentSession session, int idValoracionNoticia) throws PersistentException {
		try {
			return (ValoracionNoticia) session.load(bbdd.ValoracionNoticia.class, Integer.valueOf(idValoracionNoticia));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static ValoracionNoticia getValoracionNoticiaByORMID(PersistentSession session, int idValoracionNoticia) throws PersistentException {
		try {
			return (ValoracionNoticia) session.get(bbdd.ValoracionNoticia.class, Integer.valueOf(idValoracionNoticia));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static ValoracionNoticia loadValoracionNoticiaByORMID(PersistentSession session, int idValoracionNoticia, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ValoracionNoticia) session.load(bbdd.ValoracionNoticia.class, Integer.valueOf(idValoracionNoticia), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static ValoracionNoticia getValoracionNoticiaByORMID(PersistentSession session, int idValoracionNoticia, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ValoracionNoticia) session.get(bbdd.ValoracionNoticia.class, Integer.valueOf(idValoracionNoticia), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryValoracionNoticia(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd.ValoracionNoticia as ValoracionNoticia");
		if (condition != null)
	...
	public static ValoracionNoticia createValoracionNoticia() {
		return new bbdd.ValoracionNoticia();
	}
	
	public static boolean save(bbdd.ValoracionNoticia valoracionNoticia) throws PersistentException {
		try {
	...
	public static boolean delete(bbdd.ValoracionNoticia valoracionNoticia) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.ValoracionNoticia valoracionNoticia)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.ValoracionNoticia valoracionNoticia, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (valoracionNoticia.getUsuario_valora_a() != null) {
				valoracionNoticia.getUsuario_valora_a().valoracionNoticias.remove(valoracionNoticia);
			}
	...
	public static boolean refresh(bbdd.ValoracionNoticia valoracionNoticia) throws PersistentException {
		try {
	...
	public static boolean evict(bbdd.ValoracionNoticia valoracionNoticia) throws PersistentException {
		try {
