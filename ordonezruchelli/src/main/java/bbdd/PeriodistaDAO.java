...
public class PeriodistaDAO {
	...
	public static Periodista loadPeriodistaByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Periodista) session.load(bbdd.Periodista.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Periodista getPeriodistaByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Periodista) session.get(bbdd.Periodista.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Periodista loadPeriodistaByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Periodista) session.load(bbdd.Periodista.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Periodista getPeriodistaByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Periodista) session.get(bbdd.Periodista.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPeriodista(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd.Periodista as Periodista");
		if (condition != null)
	...
	public static Periodista createPeriodista() {
		return new bbdd.Periodista();
	}
	
	public static boolean save(bbdd.Periodista periodista) throws PersistentException {
		try {
	...
	public static boolean delete(bbdd.Periodista periodista) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.Periodista periodista)throws PersistentException {
		try {
			bbdd.Noticia[] lPublicas = periodista.publica.toArray();
			for(int i = 0; i < lPublicas.length; i++) {
				lPublicas[i].setAutor(null);
			}
			bbdd.Foto[] lTiene_imagens = periodista.tiene_imagen.toArray();
			for(int i = 0; i < lTiene_imagens.length; i++) {
				lTiene_imagens[i].setLe_da_imagen_a(null);
			}
			bbdd.Comentario[] lEscribirs = periodista.escribir.toArray();
			for(int i = 0; i < lEscribirs.length; i++) {
				lEscribirs[i].setAutor(null);
			}
			bbdd.ValoracionNoticia[] lValora_as = periodista.valora_a.toArray();
			for(int i = 0; i < lValora_as.length; i++) {
				lValora_as[i].setValorada_por(null);
			}
			bbdd.ValoracionComentario[] lVa_a_valorars = periodista.va_a_valorar.toArray();
	...
	public static boolean deleteAndDissociate(bbdd.Periodista periodista, org.orm.PersistentSession session)throws PersistentException {
		try {
			bbdd.Noticia[] lPublicas = periodista.publica.toArray();
			for(int i = 0; i < lPublicas.length; i++) {
				lPublicas[i].setAutor(null);
	...
	public static boolean refresh(bbdd.Periodista periodista) throws PersistentException {
		try {
	...
	public static boolean evict(bbdd.Periodista periodista) throws PersistentException {
		try {
