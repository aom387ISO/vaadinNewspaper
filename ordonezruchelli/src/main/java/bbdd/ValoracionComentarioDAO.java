...
public class ValoracionComentarioDAO {
	...
	public static ValoracionComentario loadValoracionComentarioByORMID(PersistentSession session, int idValoracionComentario) throws PersistentException {
		try {
			return (ValoracionComentario) session.load(bbdd.ValoracionComentario.class, Integer.valueOf(idValoracionComentario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static ValoracionComentario getValoracionComentarioByORMID(PersistentSession session, int idValoracionComentario) throws PersistentException {
		try {
			return (ValoracionComentario) session.get(bbdd.ValoracionComentario.class, Integer.valueOf(idValoracionComentario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static ValoracionComentario loadValoracionComentarioByORMID(PersistentSession session, int idValoracionComentario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ValoracionComentario) session.load(bbdd.ValoracionComentario.class, Integer.valueOf(idValoracionComentario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static ValoracionComentario getValoracionComentarioByORMID(PersistentSession session, int idValoracionComentario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (ValoracionComentario) session.get(bbdd.ValoracionComentario.class, Integer.valueOf(idValoracionComentario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryValoracionComentario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd.ValoracionComentario as ValoracionComentario");
		if (condition != null)
	...
	public static ValoracionComentario createValoracionComentario() {
		return new bbdd.ValoracionComentario();
	}
	
	public static boolean save(bbdd.ValoracionComentario valoracionComentario) throws PersistentException {
		try {
	...
	public static boolean delete(bbdd.ValoracionComentario valoracionComentario) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.ValoracionComentario valoracionComentario)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.ValoracionComentario valoracionComentario, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (valoracionComentario.getLe_da_valoracion() != null) {
				valoracionComentario.getLe_da_valoracion().valoracionComentario.remove(valoracionComentario);
			}
	...
	public static boolean refresh(bbdd.ValoracionComentario valoracionComentario) throws PersistentException {
		try {
	...
	public static boolean evict(bbdd.ValoracionComentario valoracionComentario) throws PersistentException {
		try {
