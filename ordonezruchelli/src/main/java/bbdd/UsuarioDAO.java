...
public class UsuarioDAO {
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Usuario) session.load(bbdd.Usuario.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Usuario) session.get(bbdd.Usuario.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.load(bbdd.Usuario.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.get(bbdd.Usuario.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario createUsuario() {
		return new bbdd.Usuario();
	}
	
	public static boolean save(bbdd.Usuario usuario) throws PersistentException {
		try {
	...
	public static boolean delete(bbdd.Usuario usuario) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.Usuario usuario)throws PersistentException {
		if (usuario instanceof bbdd.Periodista) {
			return bbdd.PeriodistaDAO.deleteAndDissociate((bbdd.Periodista) usuario);
		}
		
		if (usuario instanceof bbdd.Usuario_suscrito) {
			return bbdd.Usuario_suscritoDAO.deleteAndDissociate((bbdd.Usuario_suscrito) usuario);
		}
		
		if (usuario instanceof bbdd.Editor) {
			return bbdd.EditorDAO.deleteAndDissociate((bbdd.Editor) usuario);
		}
		
		try {
			bbdd.Foto[] lTiene_imagens = usuario.tiene_imagen.toArray();
			for(int i = 0; i < lTiene_imagens.length; i++) {
				lTiene_imagens[i].setLe_da_imagen_a(null);
			}
			bbdd.Comentario[] lEscribirs = usuario.escribir.toArray();
			for(int i = 0; i < lEscribirs.length; i++) {
				lEscribirs[i].setAutor(null);
			}
			bbdd.ValoracionNoticia[] lValora_as = usuario.valora_a.toArray();
			for(int i = 0; i < lValora_as.length; i++) {
				lValora_as[i].setValorada_por(null);
			}
			bbdd.ValoracionComentario[] lVa_a_valorars = usuario.va_a_valorar.toArray();
	...
	public static boolean deleteAndDissociate(bbdd.Usuario usuario, org.orm.PersistentSession session)throws PersistentException {
		if (usuario instanceof bbdd.Periodista) {
			return bbdd.PeriodistaDAO.deleteAndDissociate((bbdd.Periodista) usuario, session);
		}
		
		if (usuario instanceof bbdd.Usuario_suscrito) {
			return bbdd.Usuario_suscritoDAO.deleteAndDissociate((bbdd.Usuario_suscrito) usuario, session);
		}
		
		if (usuario instanceof bbdd.Editor) {
			return bbdd.EditorDAO.deleteAndDissociate((bbdd.Editor) usuario, session);
		}
	...
	public static boolean refresh(bbdd.Usuario usuario) throws PersistentException {
		try {
	...
	public static boolean evict(bbdd.Usuario usuario) throws PersistentException {
		try {
