...
public class EditorDAO {
	...
	public static Editor loadEditorByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Editor) session.load(bbdd.Editor.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Editor getEditorByORMID(PersistentSession session, int idUsuario) throws PersistentException {
		try {
			return (Editor) session.get(bbdd.Editor.class, Integer.valueOf(idUsuario));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Editor loadEditorByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Editor) session.load(bbdd.Editor.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Editor getEditorByORMID(PersistentSession session, int idUsuario, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Editor) session.get(bbdd.Editor.class, Integer.valueOf(idUsuario), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryEditor(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From bbdd.Editor as Editor");
		if (condition != null)
	...
	public static Editor createEditor() {
		return new bbdd.Editor();
	}
	
	public static boolean save(bbdd.Editor editor) throws PersistentException {
		try {
	...
	public static boolean delete(bbdd.Editor editor) throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(bbdd.Editor editor)throws PersistentException {
		try {
			bbdd.Foto[] lTiene_imagens = editor.tiene_imagen.toArray();
			for(int i = 0; i < lTiene_imagens.length; i++) {
				lTiene_imagens[i].setLe_da_imagen_a(null);
			}
			bbdd.Comentario[] lEscribirs = editor.escribir.toArray();
			for(int i = 0; i < lEscribirs.length; i++) {
				lEscribirs[i].setAutor(null);
			}
			bbdd.ValoracionNoticia[] lValora_as = editor.valora_a.toArray();
			for(int i = 0; i < lValora_as.length; i++) {
				lValora_as[i].setValorada_por(null);
			}
			bbdd.ValoracionComentario[] lVa_a_valorars = editor.va_a_valorar.toArray();
	...
	public static boolean deleteAndDissociate(bbdd.Editor editor, org.orm.PersistentSession session)throws PersistentException {
		try {
			bbdd.Foto[] lTiene_imagens = editor.tiene_imagen.toArray();
			for(int i = 0; i < lTiene_imagens.length; i++) {
				lTiene_imagens[i].setLe_da_imagen_a(null);
	...
	public static boolean refresh(bbdd.Editor editor) throws PersistentException {
		try {
	...
	public static boolean evict(bbdd.Editor editor) throws PersistentException {
		try {
